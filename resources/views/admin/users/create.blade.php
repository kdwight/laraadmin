                ...
                <form method="post" action="{{ route('users.store') }}" autocomplete="off">
                    ...
                    <div class="pl-lg-4">
                        <div class="form-group{{ $errors->has('username') ? ' has-danger' : '' }}">
                            ...
                            <input type="text" name="username" id="input-name" class="form-control form-control-alternative{{ $errors->has('username') ? ' is-invalid' : '' }}" placeholder="{{ __('userName') }}" value="{{ old('username') }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('role') ? ' has-danger' : '' }}">
                            ...
                            <input type="text" name="role" id="input-name" class="form-control form-control-alternative{{ $errors->has('role') ? ' is-invalid' : '' }}" placeholder="{{ __('role') }}" value="{{ old('role') }}" required autofocus>
